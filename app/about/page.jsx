...
export const metadata = {
  title: 'About - OnlineConvertTools',
  description: 'Learn more about OnlineConvertTools - your all-in-one free online tools platform.',
};
    ...
    <div className="min-h-screen bg-neutral-100 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white border border-neutral-200 rounded-xl p-8 mb-5">
          <h2 className="text-xl font-bold text-neutral-800 mb-3">What is OnlineConvertTools?</h2>
          <p className="text-neutral-600 text-sm leading-relaxed">
            OnlineConvertTools is a free, all-in-one platform offering 200+ online tools for converting,
