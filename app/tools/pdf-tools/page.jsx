      ...
      <div className="max-w-2xl mx-auto mt-12 space-y-8 px-4 pb-12">
        ...
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div><p className="text-sm font-semibold text-neutral-800 dark:text-white mb-1">Are my uploaded files secure and private?</p><p className="text-sm text-neutral-500 dark:text-neutral-400">Most PDF Tools (merge, split, the editor, and more) run entirely in your browser — your files are never uploaded anywhere. A few tools send the file to our servers because the work needs software that doesn't run in a browser: conversions from Word, Excel, PowerPoint and similar formats, PDF repair, PDF/A and PDF compression (up to 200 MB). The file is deleted once your download is ready, or automatically after a short time.</p></div>
            <div><p className="text-sm font-semibold text-neutral-800 dark:text-white mb-1">What file size limits does PDF Tools have?</p><p className="text-sm text-neutral-500 dark:text-neutral-400">The limit depends on the tool and is shown on each tool page before you choose a file. The tools that run in your browser, such as merge, split and the editor, accept files up to 700 MB on a computer and 100 MB on a phone or tablet. Compress uses our server engine up to 200 MB and a lighter in-browser optimisation above that, up to the same 700 MB / 100 MB. The tools that use our servers accept: Word and PowerPoint to PDF up to 100 MB, PDF to Word up to 100 MB (large files are limited by our server's memory); HTML, EPUB and MOBI to PDF up to 100 MB; Excel to PDF up to 60 MB (large spreadsheets are limited by conversion time, not by size); PDF repair and PDF to PDF/A up to 45 MB. Each tool page shows its own limit before you choose a file.</p></div>
