...
function CompressPDFTool() {
  ...
  return (
    <div>
      <input type="file" accept="application/pdf" onChange={(e) => setFile(e.target.files?.[0])} className="mb-4" />
      {file && <p className="text-green-400 text-sm">Fichier prêt : {file.name}</p>}
      <p className="text-neutral-400 text-sm mt-4">Fonctionnalité avancée à venir</p>
    </div>
  );
}
...
const pdfTools = [
  ...
  { id: 'rotate', title: 'Rotater pages', description: 'Tournez les pages', icon: '🔄', component: () => <div className="text-center py-8">🔄 Fonctionnalité à venir</div> },
  { id: 'watermark', title: 'Filigrane', description: 'Ajoutez un texte', icon: '💧', component: () => <div className="text-center py-8">💧 Fonctionnalité à venir</div> },
  { id: 'imagetopdf', title: 'Image → PDF', description: 'Convertissez des images', icon: '🖼️', component: () => <div className="text-center py-8">🖼️ Fonctionnalité à venir</div> },
  { id: 'pdftoimage', title: 'PDF → Image', description: 'Convertissez en images', icon: '📸', component: () => <div className="text-center py-8">📸 Fonctionnalité à venir</div> },
];
