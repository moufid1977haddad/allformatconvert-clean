...
export default function Page() {
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      ...
      <SeoContent
        title="PDF Repair"
        description="A tool to fix corrupted or damaged PDF files is not yet available — this feature is under development. Check back soon, or explore our other PDF tools in the meantime."
      />
    </div>
  );
}