...
export default function Page() {
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="bg-white border border-neutral-200 rounded-xl shadow-sm p-10 space-y-4">
          <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <ToolIcon slug="pdf-to-pdfa" className="w-8 h-8 text-red-500" />
          </div>
      ...
      <SeoContent
        title="PDF to PDF/A"
        description="A tool to convert a standard PDF into the archival PDF/A format is not yet available — this feature is under development. Check back soon, or explore our other PDF tools in the meantime."
      />
    </div>
  );
}