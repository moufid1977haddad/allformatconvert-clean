  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      ...
      <SeoContent
        ...
        description="A tool to convert PowerPoint presentations into PDF is not yet available — this feature is under development. Check back soon, or explore our other PDF tools in the meantime."
      />
    </div>
  );
}