  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-neutral-400 text-xs text-center mb-8">In our tests, layout, images, gradients, tables and charts carried over. A font missing from our servers is substituted, which can shift text, and Wingdings and Webdings icon fonts can&apos;t legally be reproduced and will appear blank.</p>
      ...
      <SeoContent
        ...
        faqs={[
          ...
          { q: "What happens if my presentation uses a font that isn't common?", a: "A font not installed on our conversion servers — for example Segoe UI, which is Windows-only — is substituted with a similar typeface rather than left blank, except Wingdings and Webdings, which can't legally be reproduced and come through as blank boxes instead. The substitute can be wider than the original, so a long title can wrap onto a second line and be partly hidden by a shape or text box placed over it." }
        ]}
        tips={[
          ...
          "Avoid Windows-only fonts (for example Segoe UI) for titles in narrow boxes: the substitute font can be wider and cause the title to wrap.",
