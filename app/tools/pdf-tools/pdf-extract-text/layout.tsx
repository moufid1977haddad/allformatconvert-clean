...
export const metadata: Metadata = {
  ...
  description: "PDF Extract Text pulls the text layer out of your PDF page by page, entirely in your browser using the PDF.js library — your file is never uploaded…",
