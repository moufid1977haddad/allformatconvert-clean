  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-neutral-400 text-xs text-center mb-8">In our tests, .docx fonts, tables, columns, headers and footers matched two other online converters.</p>
