  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-neutral-500 text-center mb-8">Convert .xlsx, .xls, and .csv files to PDF with professional-grade fidelity</p>
