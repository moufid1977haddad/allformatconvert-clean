  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      ...
      <SeoContent
        ...
        description="Add Text to Image overlays a single line of text onto your photo, entirely in your browser. Type your message, set its size and color, and position it with the X/Y sliders — no design skills or software installation needed, and nothing is uploaded to a server."
        howTo={[
          "Click the upload area and select an image from your device.",
          "Type your text, then set the font size and color.",
        ...
        faqs={[
          ...
          { q: "Can I choose a different font or add a shadow?", a: "No, the text is drawn in a fixed bold font with no shadow, outline, or transparency options — only size, color, and position are adjustable." },
        ...
        tips={[
          ...
          "If you need a second line of text, apply your first line, download the result, then re-upload it and add the second line on top.",
