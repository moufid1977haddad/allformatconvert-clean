...
export const metadata: Metadata = {
  ...
  description: "HEIC to PNG converts an iPhone HEIC photo to PNG format entirely in your browser, using the open-source heic2any library — your photo is never uploaded…",
