...
const toolColor = flatCategoryTextColors['/tools/math-tools'];

const tools = [
  { title: 'Number Base Converter', description: 'Convert between binary, decimal, hex', href: '/tools/math-tools/number-base-converter' },
  { title: 'Percentage Calculator', description: 'Calculate percentages easily', href: '/tools/math-tools/percentage-calculator' },
  { title: 'Roman Numeral Converter', description: 'Convert to and from Roman numerals', href: '/tools/math-tools/roman-numeral-converter' },
  { title: 'Scientific Calculator', description: 'Advanced scientific calculator', href: '/tools/math-tools/scientific-calculator' },
  { title: 'Fraction Calculator', description: 'Add, subtract, multiply fractions', href: '/tools/math-tools/fraction-calculator' },
  { title: 'Statistics Calculator', description: 'Mean, median, mode and more', href: '/tools/math-tools/statistics-calculator' },
];
