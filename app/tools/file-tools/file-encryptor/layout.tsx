...
export const metadata: Metadata = {
  ...
  description: "File Encryptor is a free online tool that obfuscates any file with a password-based XOR cipher, entirely in your browser — no upload, no software…",
