...
export const metadata: Metadata = {
  ...
  description: "Number Base Converter shows a number in binary, octal, decimal, and hexadecimal simultaneously, live as you type, entirely in your browser — nothing…",
