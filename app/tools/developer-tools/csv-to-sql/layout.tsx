...
export const metadata: Metadata = {
  ...
  description: "CSV to SQL generates a CREATE TABLE statement and one INSERT statement per row from a CSV file or pasted CSV text, entirely in your browser, with automatic delimiter detection — nothing is uploaded to a server.",
