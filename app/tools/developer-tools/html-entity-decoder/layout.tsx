...
export const metadata: Metadata = {
  ...
  description: "HTML Entity Decoder decodes HTML entities — named ones like nbsp, copy, and euro, and numeric ones — back into plain text using the browser's own DOMParser…",
