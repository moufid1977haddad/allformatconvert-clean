...
const tools = [
  { title: 'XML to JSON', description: 'Convert XML to JSON format', href: '/tools/developer-tools/xml-to-json' },
  { title: 'JSON to XML', description: 'Convert JSON to XML format', href: '/tools/developer-tools/json-to-xml' },
  { title: 'TSV to CSV', description: 'Convert TSV to CSV format', href: '/tools/developer-tools/tsv-to-csv' },
  { title: 'CSV to TSV', description: 'Convert CSV to TSV format', href: '/tools/developer-tools/csv-to-tsv' },
  { title: 'Excel to JSON', description: 'Convert Excel files to JSON', href: '/tools/developer-tools/excel-to-json' },
  { title: 'Excel to CSV', description: 'Convert Excel files to CSV', href: '/tools/developer-tools/excel-to-csv' },
  { title: 'CSV to Excel', description: 'Convert CSV to Excel format', href: '/tools/developer-tools/csv-to-excel' },
  { title: 'TOML to JSON', description: 'Convert TOML to JSON format', href: '/tools/developer-tools/toml-to-json' },
  { title: 'JSON to TOML', description: 'Convert JSON to TOML format', href: '/tools/developer-tools/json-to-toml' },
  ...
  { title: 'Password Generator', description: 'Generate secure passwords', href: '/tools/developer-tools/password-generator' },
  { title: 'CSV to JSON', description: 'Convert CSV to JSON', href: '/tools/developer-tools/csv-to-json' },
  { title: 'JSON to CSV', description: 'Convert JSON to CSV', href: '/tools/developer-tools/json-to-csv' },
  { title: 'CSS Formatter', description: 'Format and beautify CSS', href: '/tools/developer-tools/css-formatter' },
  { title: 'HTML Formatter', description: 'Format and beautify HTML', href: '/tools/developer-tools/html-formatter' },
  { title: 'JS Minifier', description: 'Minify JavaScript code', href: '/tools/developer-tools/js-minifier' },
  { title: 'JavaScript Formatter', description: 'Format JavaScript code', href: '/tools/developer-tools/javascript-formatter' },
  { title: 'SCSS to CSS', description: 'Convert SCSS to CSS', href: '/tools/developer-tools/scss-to-css' },
  { title: 'TypeScript to JS', description: 'Strip TypeScript types', href: '/tools/developer-tools/typescript-to-js' },
  { title: 'XML Formatter', description: 'Format and beautify XML', href: '/tools/developer-tools/xml-formatter' },
  { title: 'SQL Formatter', description: 'Format SQL queries', href: '/tools/developer-tools/sql-formatter' },
  { title: 'Regex Tester', description: 'Test regular expressions', href: '/tools/developer-tools/regex-tester' },
  { title: 'Markdown Previewer', description: 'Preview Markdown in real time', href: '/tools/developer-tools/markdown-previewer' },
  { title: 'Markdown to HTML', description: 'Convert Markdown to HTML', href: '/tools/developer-tools/markdown-to-html' },
  { title: 'JWT Decoder', description: 'Decode JWT tokens', href: '/tools/developer-tools/jwt-decoder' },
  { title: 'Markdown Editor', description: 'Write and preview Markdown', href: '/tools/developer-tools/markdown-editor' },
  { title: 'API Tester', description: 'Test REST API endpoints', href: '/tools/developer-tools/api-tester' },
  { title: 'Number Base Converter', description: 'Convert between number bases', href: '/tools/developer-tools/number-base-converter' },
  { title: 'YAML to JSON', description: 'Convert YAML to JSON', href: '/tools/developer-tools/yaml-to-json' },
  { title: 'JSON to YAML', description: 'Convert JSON to YAML', href: '/tools/developer-tools/json-to-yaml' },
  { title: 'Color Picker', description: 'Pick and convert colors', href: '/tools/developer-tools/color-picker' },
  { title: 'Timestamp Converter', description: 'Convert Unix timestamps', href: '/tools/developer-tools/timestamp-converter' },
  { title: 'Aspect Ratio', description: 'Calculate aspect ratios', href: '/tools/developer-tools/aspect-ratio' },
  { title: 'URL Parser', description: 'Parse and analyze URLs', href: '/tools/developer-tools/url-parser' },
  { title: 'HTML Encoder', description: 'Encode and decode HTML entities', href: '/tools/developer-tools/html-encoder' },
  { title: 'HTML Entity Decoder', description: 'Decode HTML entities', href: '/tools/developer-tools/html-entity-decoder' },
  { title: 'Unicode Converter', description: 'Convert text to Unicode', href: '/tools/developer-tools/unicode-converter' },
  { title: 'Hex to Text', description: 'Convert between text and hex', href: '/tools/developer-tools/hex-to-text' },
  { title: 'JSON to TypeScript', description: 'Generate TypeScript interfaces', href: '/tools/developer-tools/json-to-typescript' },
  { title: 'JSON to Go Struct', description: 'Generate Go structs from JSON', href: '/tools/developer-tools/json-to-go' },
  { title: 'JSON to Rust Struct', description: 'Generate Rust structs from JSON', href: '/tools/developer-tools/json-to-rust' },
  { title: 'JSON to Python Class', description: 'Generate Python dataclasses', href: '/tools/developer-tools/json-to-python' },
  { title: 'JSON to PHP Class', description: 'Generate PHP classes from JSON', href: '/tools/developer-tools/json-to-php' },
  { title: 'JSON to C# Class', description: 'Generate C# classes from JSON', href: '/tools/developer-tools/json-to-csharp' },
  { title: 'CSV to SQL', description: 'Generate SQL from CSV', href: '/tools/developer-tools/csv-to-sql' },
  { title: 'SQL to CSV', description: 'Extract data from SQL to CSV', href: '/tools/developer-tools/sql-to-csv' },
  { title: '.env to JSON', description: 'Convert .env files to JSON', href: '/tools/developer-tools/env-to-json' },
  { title: 'Code Minifier', description: 'Minify JS, CSS, HTML code', href: '/tools/developer-tools/code-minifier' },
  { title: 'Diff Viewer', description: 'Compare two texts', href: '/tools/developer-tools/diff-viewer' },
  { title: 'Code Formatter', description: 'Format and beautify code', href: '/tools/developer-tools/code-formatter' },
  { title: 'Cron Expression Builder', description: 'Build cron expressions', href: '/tools/developer-tools/cron-expression-builder' },
];
