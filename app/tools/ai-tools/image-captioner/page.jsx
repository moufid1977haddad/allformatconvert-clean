    ...
    try {
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 1000,
          system: 'You are an image captioning expert. Generate creative, descriptive captions for images. Since this is text-based, help the user write captions based on their image description.',
  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-neutral-500 text-center mb-8">Generate captions for images</p>
        <div className="bg-white border border-neutral-200 rounded-xl shadow-sm p-6 space-y-4">
          <textarea className="w-full bg-neutral-50 border border-neutral-200 rounded-xl p-4 text-sm h-48 resize-none" placeholder="Describe your image and I will generate a caption..." value={input} onChange={e => setInput(e.target.value)} />
