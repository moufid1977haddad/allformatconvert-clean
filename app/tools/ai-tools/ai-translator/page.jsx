    ...
    try {
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 1000,
          system: 'You are a professional translator. Translate the provided text to English (or detect and translate to the most appropriate language). Return only the translation.',
