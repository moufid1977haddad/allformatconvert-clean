...
export default function WebmToGifPage() {
  return (
    <GifFromVideoTool
      tool="webm-to-gif"
      title="WebM to GIF"
      subtitle="Convert a WebM clip into an animated GIF — choose the start, length, width and frame rate"
      seo={{
        title: 'WebM to GIF',
        description: 'WebM to GIF converts a clip of your WebM video into an animated GIF. Pick where the clip starts, how long it lasts (up to 60 seconds), the width and the frame rate. WebM videos (VP8, VP9, AV1) are supported, including screen recordings. It runs on our server with ffmpeg, which builds an optimised 256-colour palette for your clip, so it works in every browser including Safari and iPhone. Your file is deleted from our server as soon as you have downloaded the GIF.',
        howTo: [
          'Select a WebM file (up to 1 GB). Other video formats work too.',
        ...
        faqs: [
          { q: 'Is WebM to GIF free?', a: 'Yes, free with no signup and no watermark.' },
