...
export default function MovToGifPage() {
  return (
    <GifFromVideoTool
      tool="mov-to-gif"
      title="MOV to GIF"
      subtitle="Convert a MOV clip into an animated GIF — choose the start, length, width and frame rate"
      seo={{
        title: 'MOV to GIF',
        description: 'MOV to GIF converts a clip of your MOV video into an animated GIF. Pick where the clip starts, how long it lasts (up to 60 seconds), the width and the frame rate. iPhone and QuickTime videos (MOV) are supported directly, and vertical videos keep their shape. It runs on our server with ffmpeg, which builds an optimised 256-colour palette for your clip, so it works in every browser including Safari and iPhone. Your file is deleted from our server as soon as you have downloaded the GIF.',
        howTo: [
          'Select a MOV file (up to 1 GB). Other video formats work too.',
        ...
        faqs: [
          { q: 'Is MOV to GIF free?', a: 'Yes, free with no signup and no watermark.' },
