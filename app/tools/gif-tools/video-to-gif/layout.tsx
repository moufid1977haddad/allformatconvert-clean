...
export const metadata: Metadata = {
  ...
  description: "Video to GIF captures a series of frames from any video file at your chosen frame rate (1–15 FPS) and duration (1–10 seconds), then encodes them into a real…",
