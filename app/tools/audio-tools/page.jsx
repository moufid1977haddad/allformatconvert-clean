      ...
      <div className="max-w-2xl mx-auto mt-12 space-y-8 px-4 pb-12">
        ...
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div><p className="text-sm font-semibold text-neutral-800 dark:text-white mb-1">Is there a file size limit for uploads?</p><p className="text-sm text-neutral-500 dark:text-neutral-400">Most Audio Tools run in your browser, so your file never leaves your device and we do not set an upload limit; the practical limit is your device memory, and very long files can be slow or fail, especially on phones. Audio to Text is the exception: it sends the audio to our servers and accepts files up to 4 MB.</p></div>
            ...
            <div><p className="text-sm font-semibold text-neutral-800 dark:text-white mb-1">Will my uploaded files be stored or shared?</p><p className="text-sm text-neutral-500 dark:text-neutral-400">Most Audio Tools run entirely in your browser — your files never leave your device. The one exception is Audio to Text, which sends your audio to a transcription service to generate the text; it's processed in memory and never stored, discarded once your transcript is ready.</p></div>
          </div>
        </div>
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-xl p-6">
