      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-neutral-200 rounded-xl p-8">
            ...
            <p className="text-neutral-600 text-sm leading-relaxed">OnlineConverTools provides free online tools for converting, compressing, and editing files including PDFs, images, videos, audio, and more. Some features are powered by third-party AI services. The service is provided "as is" and may be updated, modified, or discontinued at any time.</p>
          </div>

          <div className="bg-white border border-neutral-200 rounded-xl p-8">
            <h2 className="text-xl font-bold text-neutral-800 mb-3">3. Permitted Use</h2>
            <p className="text-neutral-600 text-sm leading-relaxed mb-3">You may use OnlineConverTools for personal and commercial purposes. You agree NOT to:</p>
          ...
          <div className="bg-white border border-neutral-200 rounded-xl p-8">
            ...
            <p className="text-neutral-600 text-sm leading-relaxed">The content, features, design, and functionality of OnlineConverTools are owned by OnlineConverTools and protected by international copyright, trademark, and other intellectual property laws. You retain all rights to files you process through our service.</p>
          </div>
          ...
          <div className="bg-white border border-neutral-200 rounded-xl p-8">
            ...
            <p className="text-neutral-600 text-sm leading-relaxed">OnlineConverTools is provided on an "as is" and "as available" basis without warranties of any kind, either express or implied. We do not warrant that the service will be uninterrupted, error-free, secure, or free of viruses or other harmful components.</p>
          </div>

          <div className="bg-white border border-neutral-200 rounded-xl p-8">
            <h2 className="text-xl font-bold text-neutral-800 mb-3">8. Limitation of Liability</h2>
            <p className="text-neutral-600 text-sm leading-relaxed">To the maximum extent permitted by law, OnlineConverTools shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the service, including but not limited to loss of data or profits.</p>
          </div>
