  ...
  return (
    <div className="min-h-screen bg-neutral-100 p-6">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-neutral-500 text-center mb-10">Last updated: September 23, 2026</p>
            ...
            <ul className="text-neutral-600 text-sm leading-relaxed space-y-2 list-disc pl-5">
              ...
              <li><strong>File Processing:</strong> Most tools process your files entirely in your browser — nothing is uploaded to any server. A few tools require server-side processing for fidelity or capability reasons in-browser processing cannot reach; for those, your file is transmitted over HTTPS, processed, and deleted immediately afterward — never stored, logged, or kept:
                <ul className="list-disc pl-5 mt-2 space-y-1">
                  <li>Excel to PDF, PowerPoint to PDF, EPUB to PDF, MOBI to PDF, PDF Repair, PDF to PDF/A, PDF Compress (files up to 200&nbsp;MB), Background Remover, AI Image Upscaler, Video Compressor, Video Converter, the video-to-GIF tools (Video, MP4, MOV, AVI and WebM to GIF), Audio Converter when the output is Opus: processed on our own servers (self-hosted, not shared with a third party).</li>
