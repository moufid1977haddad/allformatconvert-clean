...
const allTools = [
  ...
  { name: 'Video Trimmer',        href: '/tools/media-tools/video-trimmer' },
  { name: 'Video Merger',         href: '/tools/media-tools/video-merger' },
  { name: 'Video Resizer',        href: '/tools/media-tools/video-resizer' },
  { name: 'Video Rotator',        href: '/tools/media-tools/video-rotator' },
  { name: 'Video Filter',         href: '/tools/media-tools/video-filter' },
  { name: 'Video Watermark',      href: '/tools/media-tools/video-watermark' },
  { name: 'Video Metadata',       href: '/tools/media-tools/video-metadata' },
  { name: 'Video Screenshot',     href: '/tools/media-tools/video-screenshot' },
  { name: 'Video to Audio',       href: '/tools/media-tools/video-to-audio' },
  { name: 'Video to GIF',         href: '/tools/media-tools/video-to-gif' },
  { name: 'GIF Maker',            href: '/tools/media-tools/gif-maker' },
  { name: 'GIF Compressor',       href: '/tools/media-tools/gif-compressor' },
  { name: 'Media Player',         href: '/tools/media-tools/media-player' },
  { name: 'Screen Recorder',      href: '/tools/media-tools/screen-recorder' },
  { name: 'Subtitle Generator',   href: '/tools/media-tools/subtitle-generator' },
          ...
          <nav className="hidden lg:flex items-center justify-center flex-1 gap-0.5">
            {categories.map((cat) => {
              ...
              const baseClass = isActive
                ...
                : 'text-neutral-600 dark:text-neutral-300 border-neutral-200 dark:border-neutral-600 hover:bg-neutral-100 dark:hover:bg-neutral-700';
              return (
                <div
                  key={cat.href}
