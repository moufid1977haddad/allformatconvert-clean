...
**Bloquants avant le lancement : 9 (Safari — macOS mesuré, iPhone et retest des correctifs à faire par le propriétaire) ; ~~D8 (plafond de ≈ 4,5 Mo)~~ ✅ fait le 21/09, **en production et vérifié** (pptx 99 Mio en 53,7 s sur www ; rapport) ; la saturation à trancher avant Product Hunt ; le DPA ConvertAPI (à signer par le propriétaire).** Railway Gotenberg à 3 réplicas, et la galerie Product Hunt.
