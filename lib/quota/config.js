...
function actualAiCostCents(usage) {
  ...
  return dollarsToCents(usage.prompt_tokens * GPT4O_MINI_INPUT_PER_TOKEN + usage.completion_tokens * GPT4O_MINI_OUTPUT_PER_TOKEN);
}

// Same null-for-unknown contract as actualAiCostCents above.
