...
const MAX_CONVERTAPI_FILE_BYTES = 200 * 1024 * 1024; // MEASUREMENT BUILD (was 100 MiB)
...
const MAX_OFFICE_STAGED_BYTES = 200 * 1024 * 1024; // MEASUREMENT BUILD (was 100 MiB)
...
const MAX_HTML_STAGED_BYTES = 200 * 1024 * 1024; // MEASUREMENT BUILD (was 30 MiB)
const MAX_PDF_TO_WORD_STAGED_BYTES = 200 * 1024 * 1024; // MEASUREMENT BUILD (was 60 MiB)
const MAX_SPREADSHEET_STAGED_BYTES = 100 * 1024 * 1024; // MEASUREMENT BUILD (was 15 MiB)
...
const MAX_PDFTOOLS_STAGED_BYTES = 200 * 1024 * 1024; // MEASUREMENT BUILD (was 30 MiB) // largest measured (30.4 MB repaired in 15 s)
...
const MAX_IMAGE_CAPTIONER_ORIGINAL_BYTES = 200 * 1024 * 1024; // MEASUREMENT BUILD
