...
const MAX_HTML_STAGED_BYTES = 30 * 1024 * 1024;
...
const MAX_PDFTOOLS_STAGED_BYTES = 30 * 1024 * 1024; // largest measured (30.4 MB repaired in 15 s)
...
module.exports = {
  MAX_HTML_STAGED_BYTES, MAX_PDF_TO_WORD_STAGED_BYTES, MAX_SPREADSHEET_STAGED_BYTES, MAX_PDFTOOLS_STAGED_BYTES, MAX_AUDIO_STAGED_BYTES, MAX_OFFICE_STAGED_BYTES, OFFICE_STAGED_THRESHOLD_BYTES,
