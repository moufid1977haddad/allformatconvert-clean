...
const MAX_CONVERTAPI_FILE_BYTES = 1024 * 1024 * 1024; // MEASUREMENT BUILD (was 25 MiB, spec §5)
...
const MAX_OFFICE_STAGED_BYTES = 1024 * 1024 * 1024; // MEASUREMENT BUILD -- to be replaced by the measured ceiling
...
const OFFICE_STAGED_THRESHOLD_BYTES = 0;
...
module.exports = {
  MAX_PDFTOOLS_STAGED_BYTES, MAX_AUDIO_STAGED_BYTES, MAX_OFFICE_STAGED_BYTES, OFFICE_STAGED_THRESHOLD_BYTES,
